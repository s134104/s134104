(function() {
    ...
    var svg = d3.select("#calendarviewClinton").selectAll("svg")
    ...
    var year_titles = svg.selectAll(".year-title")  // Jan, Feb, Mar and the whatnot
        ...
        .enter().append("text")
          .text(yearTitle)
          .attr("x", function(d, i) { return width/2 - 250; })
    ...
    d3.csv("d3/calendarview/calendarview.csv", function(error, csv) {
      var data = d3.nest()
    ...
    function yearTitle (t0) {
      return "HILLARY CLINTON - " + t0.toString().split(" ")[3];
    }
