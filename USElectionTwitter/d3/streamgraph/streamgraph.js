...
chart("d3/streamgraph/streamgraph.csv", "blue");
...
var graph = d3.csv(csvpath, function(data) {
  ...
  svg.selectAll(".layer")
    ...
    .on("mousemove", function(d, i) {
      ...
      getDate = x.invert(mousex).getDate() + "/" + x.invert(mousex).getMonth() + "/" + x.invert(mousex).getYear();
    ...
    .on("mouseout", function(d, i) {
     svg.selectAll(".layer")
      ...
      d3.select(this)
      .classed("hover", false)
      .attr("stroke-width", "0px"), tooltip.html( "<p>" + d.key + "<br>" + Number(pro).toFixed(2) + "% of this day" + "<br>" + mousedate + "</p>" ).style("visibility", "hidden");
  })
  ...
  d3.select("#streamgraph")
      .on("mousemove", function(){  
         mousex = d3.mouse(this);
         mousex = mousex[0];
         tooltip.style("left", mousex + 10 + 5+ "px");
         vertical.style("left", mousex + 1 + "px" )})
